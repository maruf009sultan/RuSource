...
export const Route = createFileRoute("/roadmap")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: absUrl("/roadmap") },
      { name: "keywords", content: "russian learning roadmap, A1 to C2, russian study plan, learn russian step by step, CEFR roadmap, russian levels, russian progress" },
    ],
    links: [{ rel: "canonical", href: absUrl("/roadmap") }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Roadmap", item: absUrl("/roadmap") },
          ],
        }),
      },
      {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <nav aria-label="Breadcrumb" className="font-mono text-xs uppercase tracking-widest text-muted-foreground">
        ...
        <span className="text-signal">Roadmap</span>
      </nav>
      <div className="mt-3 font-mono text-xs uppercase tracking-widest text-signal">§ Roadmap</div>
